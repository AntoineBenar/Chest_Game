...
function mouvement(thisCase) {
    ...
    if (document.getElementById(thisCase.id).classList.contains('pionblancadd')) {
        ...
        movepionblanc();
        document.getElementById(thisCase.id).classList.remove('pion-noir');
        document.getElementById(thisCase.id).classList.remove('tour-noir');
        document.getElementById(thisCase.id).classList.remove('cavalier-noir');
        document.getElementById(thisCase.id).classList.remove('fou-noir');
        document.getElementById(thisCase.id).classList.remove('reine-noir');
        document.getElementById(thisCase.id).classList.remove('roi-noir');
    ...
    if (document.getElementById(thisCase.id).classList.contains('pionnoiradd')) {
        ...
        document.getElementById(thisCase.id).classList.remove('pion-blanc');
        document.getElementById(thisCase.id).classList.remove('tour-blanc');
        document.getElementById(thisCase.id).classList.remove('cavalier-blanc');
        document.getElementById(thisCase.id).classList.remove('fou-blanc');
        document.getElementById(thisCase.id).classList.remove('reine-blanc');
        document.getElementById(thisCase.id).classList.remove('roi-blanc');
